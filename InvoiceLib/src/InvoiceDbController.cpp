...
{
   IncomePerClientId idData = getIncomePerClientId();
...
void InvoiceDbController::groupCompanyResults(const IdParentingMap &finalParentMap, IncomePerClientId &idData)
{
